...
public class MinStackOptimisationForIncrementalData {
     ...
     */
    public MinStackOptimisationForIncrementalData() {
        d = new ArrayDeque<>();
        dmin = new ArrayDeque<>();
    }
    ...
    public static void main(String args[]) {
        MinStackOptimisationForIncrementalData m = new MinStackOptimisationForIncrementalData();
        System.out.println("========================");
        m.hack();
        System.out.println("========================");
        m.push(-2);
